...
(function () {
  ...
  var I18N = {
    ru: {
      'meta.title': 'BestShine — оклейка авто плёнкой и окрас под толщиномер в Астане',
      'meta.desc': 'Студия BestShine под ТРЦ «Сауран»: круговая оклейка плёнкой от 650 000 ₸, локальный окрас под толщиномер от 60 000 ₸ и от 3 часов. Оставьте машину — и идите по делам. Астана, ул. Алматы 3/1, ежедневно 10:00–20:00.',
      'nav.sauran': 'Студия', 'nav.uslugi': 'Услуги', 'nav.okras': 'Окрас',
      'nav.raboty': 'Работы', 'nav.contact': 'Контакты',
      'hdr.wa': 'WhatsApp',
      'cta.wa': 'Написать в WhatsApp', 'cta.prices': 'Услуги и цены',
      'hero.overline': 'Астана · ул. Алматы 3/1 · студия под ТРЦ «Сауран»',
      'hero.h1': 'Кузов как с завода. Даже под толщиномером.',
      'hero.lead': 'Оклейка авто плёнкой и локальный окрас — больше 20 лет в деле. Оставьте машину у нас внизу, поднимитесь в «Сауран» — и заберите готовую в тот же день.',
      'hero.st1': 'лет опыта', 'hero.st2t': 'от 3 ч', 'hero.st2': 'локальный окрас',
      'hero.st3': 'ежедневно, без выходных',
      'hero.down': 'вниз, на этаж −1',
      'mq.1': 'Круговая оклейка', 'mq.2': 'Смена цвета', 'mq.3': 'Люкс-пакет',
      'mq.4': 'Детальная оклейка', 'mq.5': 'Замена плёнки', 'mq.6': 'Окрас под толщиномер',
      ...
      'sa.q2': '«Покрасим, пока вы одеваетесь»',
      ...
      'sa.t3time': '+3 часа', 'sa.t3t': 'Локальный окрас готов',
      'sa.t3d': 'Небольшие работы отдаём в тот же день — к вашему возвращению.',
      'sa.t4time': 'до 20:00', 'sa.t4t': 'Забираете машину',
      'sa.t4d': 'Работаем каждый день с 10:00 до 20:00 — удобно и после работы.',
      'us.overline': 'Прайс', 'us.h2': 'Услуги и цены',
      'us.lead': 'Цены стартовые — точный расчёт делаем по фото вашего авто в WhatsApp за 10 минут.',
      ...
      'us.c6d': 'Наша фирменная работа — прибор не увидит разницы. Подробнее ниже.',
      'us.c6p': 'от 60 000 ₸',
      'us.req': 'по запросу', 'us.go': 'рассчитать →', 'us.more': 'подробнее ↓',
      'ok.overline': 'Фирменная услуга',
      'ok.h2': 'Локальный окрас под толщиномер',
      ...
      'ra.lead': 'Mercedes-Maybach, BMW M, Lexus LX, Land Cruiser, GMC — премиум-седаны и рабочие внедорожники Астаны проходят через нашу студию.',
      ...
      'f.s5': 'Замена плёнки', 'f.s6': 'Смена цвета плёнкой', 'f.s7': 'Другое',
    ...
    kk: {
      'meta.title': 'BestShine — Астанада көлікті үлдірмен қаптау және өлшегішке білінбейтін бояу',
      'meta.desc': '«Сауран» СОО астындағы BestShine студиясы: толық қаптау 650 000 теңгеден, қалыңдық өлшегішке білінбейтін жергілікті бояу 60 000 теңгеден және 3 сағаттан. Көлікті қалдырыңыз да, өз шаруаңызбен айналысыңыз. Астана, Алматы көшесі 3/1, күн сайын 10:00–20:00.',
      'nav.sauran': 'Студия', 'nav.uslugi': 'Қызметтер', 'nav.okras': 'Бояу',
      'nav.raboty': 'Жұмыстар', 'nav.contact': 'Байланыс',
      'hdr.wa': 'WhatsApp',
      'cta.wa': 'WhatsApp арқылы жазу', 'cta.prices': 'Қызметтер мен бағалар',
      'hero.overline': 'Астана · Алматы көшесі, 3/1 · «Сауран» СОО астындағы студия',
      'hero.h1': 'Шанақ зауыттан шыққандай. Қалыңдық өлшегіш те байқамайды.',
      'hero.lead': 'Көлікті үлдірмен қаптау және жергілікті бояу — бұл салада 20 жылдан астам тәжірибеміз бар. Көлікті төменде бізге қалдырып, «Сауранға» көтеріліңіз де, дайын көлікті сол күні-ақ алып кетіңіз.',
      'hero.st1': 'жыл тәжірибе', 'hero.st2t': '3 сағаттан', 'hero.st2': 'жергілікті бояу',
      'hero.st3': 'күн сайын, демалыссыз',
      'hero.down': 'төменге, −1 қабатқа',
      'mq.1': 'Толық қаптау', 'mq.2': 'Түсті өзгерту', 'mq.3': 'Люкс-пакет',
      'mq.4': 'Жеке элементтерді қаптау', 'mq.5': 'Үлдірді ауыстыру', 'mq.6': 'Өлшегішке білінбейтін бояу',
      ...
      'sa.f0t': '«Сауран» СОО', 'sa.f0d': 'кофе, кино, сауда, киім үлгілеу',
      'sa.f1d': 'көлігіңіз жұмыс үстінде',
      'sa.q1': '«Сіз сауда жасағанша, үлдірді ауыстырамыз»',
      'sa.q2': '«Сіз киім таңдағанша, бояп үлгереміз»',
      ...
      'sa.t3time': '+3 сағат', 'sa.t3t': 'Жергілікті бояу дайын',
      'sa.t3d': 'Шағын жұмыстарды сол күні-ақ, сіз оралғанша бітіреміз.',
      ...
      'us.overline': 'Бағалар', 'us.h2': 'Қызметтер мен бағалар',
      'us.lead': 'Бағалар бастапқы — нақты есепті көлігіңіздің фотосы бойынша WhatsApp арқылы 10 минутта жасаймыз.',
      ...
      'us.c3d': 'Жеке элементтер: фарадан бастап кез келген бөлшекке дейін.',
      'us.c3p': '35 000 теңгеден',
      'us.c4t': 'Үлдірмен түс өзгерту',
      'us.c4d': 'Бояусыз жаңа түс — қалауыңызша бастапқы қалпына қайтаруға болады.',
      'us.c5t': 'Үлдірді ауыстыру',
      'us.c5d': 'Ескісін сыпырып, шанақты дайындап, қайта қаптаймыз.',
      'us.c6t': 'Өлшегішке білінбейтін жергілікті бояу',
      'us.c6d': 'Біздің фирмалық жұмысымыз — құрал айырмасын көрмейді. Толығырақ төменде.',
      'us.c6p': '60 000 теңгеден',
      'us.req': 'бағасы сұраныс бойынша', 'us.go': 'есептеу →', 'us.more': 'толығырақ ↓',
      'ok.overline': 'Фирмалық қызмет',
      'ok.h2': 'Қалыңдық өлшегішке білінбейтін жергілікті бояу',
      ...
      'ok.gaugeMid': 'зауыттық аралық',
      'ok.p1t': 'Қабат — зауыттағыдай',
      'ok.p1d': 'Жабын қалыңдығы зауыттық мән шегінде — мұқият өлшеу де жөндеуді байқатпайды.',
      'ok.p2t': 'Түсі дәл',
      ...
      'ra.lead': 'Mercedes-Maybach, BMW M, Lexus LX, Land Cruiser, GMC — Астананың премиум седандары мен жол талғамайтын көліктері біздің студиядан өтеді.',
      'ra.v1': 'Үлдір құбылуы', 'ra.coupe': 'Жұмыстағы купе',
      'ra.ig': 'толығырақ Instagram парақшасында →',
      ...
      'f.s5': 'Үлдірді ауыстыру', 'f.s6': 'Үлдірмен түс өзгерту', 'f.s7': 'Басқа',
      'f.msg': 'Қосымша ақпарат', 'f.msgPh': 'Не істеу керек? Қысқаша жазсаңыз болады.',
      'f.submit': 'WhatsApp арқылы есеп алу',
      'f.note': 'Түймені бассаңыз, дайын хабарламасы бар WhatsApp ашылады. Ештеңе еш жерге сақталмайды.',
      'th.h': 'Рахмет!',
      ...
      'wa.name': 'Есімім', 'wa.car': 'Көлік', 'wa.service': 'Қызмет', 'wa.msg': 'Пікір'
    }
  };

...
(function () {
  ...
  var I18N = {
    ...
    kk: {
      ...
      'hero.lead': 'Көлікті үлдірмен қаптау және жергілікті бояу — бұл салада 20 жылдан астам жұмыс істеп келеміз. Көлікті төменде бізге қалдырып, «Сауранға» көтеріліңіз де, дайын көлікті сол күні-ақ алып кетіңіз.',

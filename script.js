...
(function () {
  ...
  var I18N = {
    ru: {
      'meta.title': 'BestShine - детейлинг-студия в Астане: оклейка авто плёнкой',
      'meta.desc': 'Детейлинг-студия BestShine под ТРЦ «Сауран»: круговая оклейка плёнкой от 650 000 ₸, смена цвета, детальная оклейка от 35 000 ₸. Также локальный окрас под толщиномер. Астана, ул. Алматы 3/1, ежедневно 10:00–20:00.',
      'nav.sauran': 'Студия', 'nav.plenka': 'Плёнка', 'nav.uslugi': 'Услуги',
      ...
      'hero.h1': 'Оклейка плёнкой. Кузов остаётся как новый.',
      'hero.lead': 'Детейлинг-студия в Астане: круговая оклейка, смена цвета, защита от сколов. 20+ лет в плёнке. Оставьте машину внизу и поднимитесь в «Сауран» - работаем, пока вы наверху.',
      ...
      'pl.overline': 'Главное направление',
      ...
      'ok.overline': 'Если краска всё-таки нужна',
    ...
    kk: {
      'meta.title': 'BestShine - Астанадағы детейлинг-студия: көлікті үлдірмен қаптау',
      'meta.desc': '«Сауран» СОО астындағы BestShine детейлинг-студиясы: толық қаптау 650 000 теңгеден, түсті өзгерту, жеке элементтерді қаптау 35 000 теңгеден. Сондай-ақ өлшегішке білінбейтін жергілікті бояу. Астана, Алматы көшесі 3/1, күн сайын 10:00–20:00.',
      'nav.sauran': 'Студия', 'nav.plenka': 'Үлдір', 'nav.uslugi': 'Қызметтер',
      ...
      'hero.h1': 'Үлдірмен қаптау. Шанақ жаңа күйінде қалады.',
      'hero.lead': 'Астанадағы детейлинг-студия: толық қаптау, түсті өзгерту, тас тиюден қорғау. Үлдір саласында 20 жылдан астам жұмыс істеп келеміз. Көлікті төменде қалдырып, «Сауранға» көтеріліңіз - сіз жоғарыда жүргенде біз жұмыс істейміз.',
      ...
      'ok.overline': 'Егер бояу қажет болса',
